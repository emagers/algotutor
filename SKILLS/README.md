...
- **AlgoTutor** is a local interview-prep web app: 200 problems, 1647 tests, runnable in JS / Rust / Go.
...
- **Tests**: `npm test` runs the dataset against the reference solutions; `npx playwright test` runs the headless E2E suite against the live Docker stack.

## Operating principles

1. **Run the existing tests before and after every change.** Never assume; verify.
